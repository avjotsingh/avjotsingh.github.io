...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-finally-setup-a-personal-website-looking-forward-to-posting-technical-articles-and-paper-summaries",
          title: 'Finally setup a personal website. Looking forward to posting technical articles and paper...',
          description: "",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-practical-byzantine-fault-tolerance",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%61%76%6A%6F%74.%73%69%6E%67%68%39%39@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/avjotsingh", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/avjot-singh", "_blank");
        },
      },];
